<template>
  <nav>
    <div
      class="back-button"
      v-if="selectedNavTile"
      @click="selectedNavTile = null"
    >
      <svg
        width="24"
        height="24"
      ...
      >
        <path
          d="M12.0002 16.6673L7.3335 12.0007L12.0002 7.33398"
          stroke="white"
    ...
    <div v-else class="logo">
      ...
      >
        <path
          d="M44 43.1665H20.9073V40.5158H41.335V34.0402H30.0878V31.3894H44V43.1665Z"
          fill="white"
          fill-opacity="0.9"
        />
        <path
        ...
        />
        <path
          d="M27.4225 4V16.8451C26.5087 16.9719 25.6126 17.2032 24.7524 17.5351V6.65589H15.5722V4H27.4225Z"
          fill="white"
          fill-opacity="0.9"
        />
        <path
...
const { selectedNavTile } = useNavigationState();
